...
<style>
    ...
    .risk-intermediate .risk-percentage { color: #ffc107; }
...
def main():
    ...
    <div class="main-header">
        ...
        <p style="color: #888; font-size: 0.9rem;">Evidence-based clinical decision support tool</p>
    </div>
    """, unsafe_allow_html=True)
